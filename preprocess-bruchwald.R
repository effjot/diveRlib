...
baro.all.files <- build.filenames(c(
  ...
  "2013-09-11", "Baro Bruchwald ULN^K1941^13-09-11 16-22-26"))
...
diver.files <- lapply(
  list(was205 = c("2011-08-02", "GW-WAS-205",
         ...
         "2013-09-11", "GW-WAS-205^J9438^13-09-11 15-37-27"),
       was206 = c("2013-03-25+26", "KORR_GW-WAS-206",
         "2013-09-11", "GW-WAS-206^75778^13-09-11 15-25-16"),
       was209 = c("2011-05-05", "GW-WAS-209 Location korrigiert",
         ...
         "2013-09-11", "GW-WAS-209^H0997^13-09-11 15-05-45"),
       was210 = c("2013-09-11", "GW-WAS-210^J4511^13-09-11 15-09-16"),
